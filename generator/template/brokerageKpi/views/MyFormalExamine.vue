  ...
  methods: {
    ...
    $_toMyTeams() {
      if (this.brokerageKpi.agentCode != "" && this.res.currentLevel) {
        ...
        this.go("brokerageKpi/myFormalTeam?indexcalno=" + this.indexcalno + "&currentLevel=" + this.res.currentLevel);
