        ...
        <div class="content-detail" v-for="(item, index) in tabs[curIndex].list" :key="index">
          ...
          <div class="detail-table-content">
            ...
            <div class="detail-table flex-one">
              ...
              <div class="detail-table-title">{{ item.bak1 }}</div>
            </div>
            <div class="detail-table flex-three">
              <div class="detail-table-title">生效日期</div>
              <div class="detail-table-title">{{ item.cvalidate | getDate }}</div>
            </div>
            <div class="detail-table flex-three">
              <div class="detail-table-title">回执日期</div>
              <div class="detail-table-title">{{ item.getpoldate | getDate }}</div>
            </div>
...
export default {
  ...
  methods: {
    ...
    changeTab(item, i, curIndex) {
      ...
      console.log("%c changeTab i", "color:#00CD00", i);
      console.log("%c changeTab item", "color:#00CD00", item);
