  ...
  <div class="brokerageKpi-my-formal-team">
    <al-all-head :title="title">
      <div slot="head_bottom">
        ...
        <div class="header-title">
          直属属员{{ teamsData.directCount }}人，预计晋升{{ teamsData.promoteCount }}人，预计维持{{
            teamsData.holdCount
    ...
    >
      <div class="content">
        <div class="team-content">
          <div class="team-detail">
            <div class="detail-head" :style="{ borderRadius: directlyGroupShow ? '5px' : '5px 5px 0 0' }">
              <div v-if="currentLevel == 'B11' || currentLevel == 'B21' || currentLevel == 'B31'">直辖组</div>
              <div v-if="currentLevel == 'B41' || currentLevel == 'B51' || currentLevel == 'B61'">直辖部</div>
              <div v-if="currentLevel == 'B71'">直辖区</div>
              <div
                class="arrow"
            ...
            >
              ...
              <div
                class="list-detail"
                v-for="(item, index) in directlyGroupList"
                :key="index"
                @click="toHisExamine(item)"
              >
                <div class="list-left">
        ...
        <div class="team-content margin-top">
          <div class="team-detail">
            <div class="detail-head" :style="{ borderRadius: nurturingGroupShow ? '5px' : '5px 5px 0 0' }">
              <div v-if="currentLevel == 'B11' || currentLevel == 'B21' || currentLevel == 'B31'">培育组</div>
              <div v-if="currentLevel == 'B41' || currentLevel == 'B51' || currentLevel == 'B61'">培育部</div>
              <div v-if="currentLevel == 'B71'">培育区</div>
              <div
                class="arrow"
            ...
            >
              ...
              <div
                class="list-detail"
                v-for="(item, index) in nurturingGroupList"
                :key="index"
                @click="toHisExamine(item)"
              >
                <div class="list-left">
...
export default {
  ...
  data() {
    return {
      ...
      currentLevel: this.$route.query["currentLevel"],
    };
  },
  methods: {
    ...mapMutations([
