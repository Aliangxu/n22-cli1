<template>
  <div class="n22-proposal-book-simple">
    <transition name="n22-base-fade">
      <router-view v-if="isShowRouterView" class="n22-proposal-book-simple-child-view"></router-view>
    </transition>
  </div>
</template>
...
export default {
  name: "proposal-book-simple", //使用xx-xx-xx命名方式具体看操作文档
  props: {
