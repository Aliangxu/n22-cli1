...
const renewalQuery = () => import(/* webpackChunkName: "renewalQuery" */ "@m/renewal/views/RenewalQuery.vue");
const historyService = () => import( /* webpackChunkName: "renewalhistoryService" */ "@m/renewal/views/HistoryService.vue")
const addRecord = () => import( /* webpackChunkName: "renewaladdRecord" */ "@m/renewal/views/AddRecord.vue")
const withholdDetail = () => import( /* webpackChunkName: "renewalwithholdDetail" */ "@m/renewal/views/WithholdDetail.vue")
const supervisorList = () => import( /* webpackChunkName: "renewalsupervisorList" */ "@m/renewal/views/SupervisorList.vue")
const bankBranchList = () => import( /* webpackChunkName: "renewalbankBranchList" */ "@m/renewal/views/BankBranchList.vue")
...
export default [
  {
    ...
    children: [
      ...
      {
        name: "renewalRenewalQuery",
        path: "renewalQuery",
        component: renewalQuery,
        meta: {
          title: "", //标题
          login: true, //是否需要登陆权限
          transition: true, //是否滑动切换页面
      ...
      {
          name: "renewalWithholdDetail",
          path: "withholdDetail",
          component: withholdDetail,
          meta: {
              title: "续期代扣记录", //标题
              login: true, //是否需要登陆权限
              transition: true,//是否滑动切换页面
      ...
      {
          name: "renewalBankBranchList",
          path: "bankBranchList",
          component: bankBranchList,
          meta: {
              title: "银行网点查询", //标题--银行网点列表-----废弃--合并使用上面的页面
              login: true, //是否需要登陆权限
              transition: true,//是否滑动切换页面
              footer: false,//是否需要底部footer菜单
              scrollToTop: false,//是否返回顶部
