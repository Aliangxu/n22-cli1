<template>
  <div class="n22-download">
    <transition name="n22-base-fade">
      <router-view v-if="isShowRouterView" class="n22-download-child-view"></router-view>
    </transition>
  </div>
</template>
...
export default {
  name: "download", //使用xx-xx-xx命名方式具体看操作文档
  props: {
  ...
  mounted() {
    console.log("%c download-生命周期-mounted", "color:green;", "");
    let _this = this;
    setTimeout(() => {
